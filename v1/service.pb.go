...
type UserServiceClient interface {
	Register(ctx context.Context, in *UserAccount, opts ...grpc.CallOption) (*Result, error)
	Login(ctx context.Context, in *UserAccount, opts ...grpc.CallOption) (*Result, error)
...
func (c *userServiceClient) Register(ctx context.Context, in *UserAccount, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := grpc.Invoke(ctx, "/v1.UserService/Register", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) Login(ctx context.Context, in *UserAccount, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := grpc.Invoke(ctx, "/v1.UserService/Login", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	Register(context.Context, *UserAccount) (*Result, error)
	Login(context.Context, *UserAccount) (*Result, error)
...
func _UserService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Register(ctx, req.(*UserAccount))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Login(ctx, req.(*UserAccount))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
